...
RUN curl -OL https://github.com/arthow4n/sharp-libvips/releases/download/v8.6.3/libvips-8.6.3-linux-x64.tar.gz && tar xf libvips-8.6.3-linux-x64.tar.gz -C /usr/local
